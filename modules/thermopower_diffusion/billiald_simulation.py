...
to_csv = True
T_fridge = 0.170
DV = np.arange(100,1100,100)*1E-9*230.9
...
#Alpha = np.logspace(-1, 2, 20, endpoint=False) # for full scan mode
Alpha = np.arange(28.0,30, 0.1) # for research mode
